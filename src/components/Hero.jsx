                ...
                <div className="row">
                    ...
                    <div className="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-6">
                        <div style={{ margin: '90px 80px' }}>
                            ...
                            <div className='my-5'>
                                <button type="button" className="btn rounded-pill px-4 btn-primary btn-lg mx-3">Find Jobs</button>
                                <button type="button" className="btn rounded-pill px-4 btn-outline-primary btn-lg">+ Post Jobs</button>
                            </div>
                        </div>
                    </div>
                </div>
